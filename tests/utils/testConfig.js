...
export const testConfig = {
  ...
  qwenTts: {
    ...
    timeoutPerChar: parseInt(process.env.QWEN_TTS_TIMEOUT_PER_CHAR_MS) || 40,
    timeoutMax: parseInt(process.env.QWEN_TTS_TIMEOUT_MAX) || 900000,
    daemonStartupTimeout: parseInt(process.env.QWEN_TTS_DAEMON_STARTUP_TIMEOUT) || 300000,
    preWarmDaemon: false,
